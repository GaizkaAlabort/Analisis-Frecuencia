...
#Introduce el texto a desencriptar
...
#Cuenta las cantidades de apariciones de cada letra en el texto
letters = Counter(text)
print("cantidad de letras = ", len(letters))

print(letters.most_common(len(letters)))

#Después de ver la frecuenza de las letras, introducir manualmente los reemplazos probando de 2 en 2 o de 3 en 3 segun la lista de frecuencias
...
#Imprimir en pantalla en nuevo texto modificado
print(text)
